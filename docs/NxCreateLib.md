...
npx nx generate @nrwl/js:library connector-bsc --publishable --importPath=@steadfastdigital/connector-bsc --unitTestRunner=jest --projectNameAndRootFormat=derived
```
